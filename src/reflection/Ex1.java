...
public class Ex1 {
    public static void main(String[] args) throws ClassNotFoundException, NoSuchFieldException, NoSuchMethodException {
        ...
        // Первый вариант создания объекта класса класс
        Class employeeClass = Class.forName("reflection.Employee");

//        // Второй вариант создания объекта класса класс
//        Class employeeClass2 = Employee.class;
//
//        // Третий вариант создания объекта класса класс
...
//        Class employeeClass3 = emp.getClass();
        ...
        System.out.println("ReturnType of method increaseSalary = " + someMethod1.getReturnType() + ", parameter types = " + Arrays.toString(someMethod1.getParameterTypes()));
        System.out.println("-----------------------------------------------------------------------------------------");

        Method someMethod2 = employeeClass.getMethod("setSalary", double.class);
        System.out.println("ReturnType of method setSalary = " + someMethod2.getReturnType() + ", parameter types = " + Arrays.toString(someMethod2.getParameterTypes()));
        System.out.println("-----------------------------------------------------------------------------------------");
